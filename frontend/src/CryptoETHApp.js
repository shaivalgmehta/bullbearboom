...
const columnMap = {
  ...
  'force_index_7_week': '4-Week Force Index',
  'force_index_52_week': '14-Week Force Index',
  ...
  'force_index_7_week_rank': '4-Week Force Index Rank',
  'force_index_52_week_rank': '14-Week Force Index Rank',
...
function CryptoETHApp({ drawerOpen, toggleDrawer }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const result = await axios.get(`${API_URL}/crypto/latest_eth?date=${formattedDate}`);
