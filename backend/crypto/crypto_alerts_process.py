...
def detect_3day_ha_color_changes(symbol, date, base, lookback_days=90):
    """
...
def detect_2week_ha_color_changes(symbol, date, base, lookback_days=200):
    """
    ...
    with get_db_connection() as conn:
        with conn.cursor() as cur:
            ...
            for alert in crypto_alerts:
                ...
                ha_3d_alerts = detect_3day_ha_color_changes(stock, date, base)
                ha_2w_alerts = detect_2week_ha_color_changes(stock, date, base)
