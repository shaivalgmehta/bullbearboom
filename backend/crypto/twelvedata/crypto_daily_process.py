...
from crypto_get_data_functions import fetch_stock_list_twelve_data, fetch_technical_indicators_twelve_data, fetch_williams_r_twelve_data, fetch_force_index_data, store_force_index_data, store_williams_r_data, store_stock_data
...
def main():
    ...
    for i in range(0, len(stocks), batch_size):
        ...
        for stock in batch:
            print(f"- {stock['symbol']}: {stock['currency_base']}")
