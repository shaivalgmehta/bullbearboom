...
def get_follow_up_prices(stock: str, transaction_date: datetime, 
    ...
    """
    Get 1-month and 3-month follow-up prices from in_daily_table.
...
def store_insider_trades(trades: List[Dict], batch_size: int = 50):
    ...
    for batch_num in range(num_batches):
        ...
        try:
            execute_values(cur, """
                INSERT INTO in_insider_trading_table (
        ...
        for batch_num in range(num_batches):
            ...
            for transaction_date, stock in batch:
                try:
                    ...
                    cur.execute("""
                        UPDATE in_insider_trading_table
...
def update_all_missing_returns(batch_size: int = 50):
    """
    One-time function to update all records in in_insider_trading_table
